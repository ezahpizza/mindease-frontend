...
const ContactPage = () => {
    ...
    return (
        <div className="min-h-screen bg-deepPurple/70">
            ...
            <div className="bg-deepPurple/60 rounded-3xl p-8 shadow-lg max-w-2xl mx-auto flex justify-center items-center flex-col">
                    <h1 className="text-3xl font-bold text-lightBg mb-8 text-center">Get in Touch</h1>
                    <form onSubmit={onSubmit} className="bg-primary space-y-6 rounded-3xl p-8 shadow-lg w-4/5 max-w-3xl flex-col">
                    ...
                    <div className="mt-8 text-center">
                        <p>Need immediate support? Visit our <a href="/ResourcePage" className="text-primary hover:underline">Resources</a> page.</p>
                    </div>
                </div>
            </main>
        </div>
